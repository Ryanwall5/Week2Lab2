...
namespace Lab2_RyanWall.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FirstName,LastName,EmailAddress,NickName,address,FavoriteNBATeam,DoYouPlayVG")] User user)
        {
